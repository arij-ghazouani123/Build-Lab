...
function RepositorySelect(props) {
    ...
    const [selectedAndroidModule, setSelectedAndroidModule] = useState("");
    ...
    axios.post(
      ...
      .then((response) => {
        ...
        if (response.status === 204) {
          ...
          alert("Please Select Android Application");
        }
      })
      .catch((error) => {
        console.log("Please Select Android Application");
        alert("Please Select Android Application ");
      });
  };
...
const handleBuildClick = () => {
  ...
  const handleAndroidModuleChange = (event) => {
    setSelectedAndroidModule(event.target.value);
  };
  ...
  <>
   ...
   <img src="data:image/svg+xml;base64," alt="GitHub" />
    <h1 class="text-center"  style={{color: "white"}}>Connect with GitHub</h1>
  ...
  <h1> Branches</h1>
  <Button className="btn btn-secondary btn-sm icon-btn"  onClick={() => setShowModal(true)}>
    ...
    <th style={{width: "40%"}}>Name</th>
      ...
      <th className="text-center" style={{width: "30%"}}>Build progress</th>
      <th style={{width: "20%"}}>Logs</th>
      <th className="text-center" style={{width: "30%"}}>Config</th>
      <th className="text-center" style={{width: "30%"}}>Build</th>
    </tr>
  </thead>
  <tbody>
    {branches.map((branch) => (
      <tr key={branch.name} onClick={() => setSelectedBranch(branch)}>
        ...
        <td className="text-center">
          {isBuildComplete ? (
            ...
            <span className="badge bg-success">Succeed</span>
          ) : progress > 0 ? (
        ...
        <td>
          <div className="btn-group" role="group">
            {isBuildComplete && (
              downloadLink ? (
                <a href={downloadLink} download className="btn btn-secondary btn-sm icon-btn">Download Logs</a>
              ) : (
                <button className="btn btn-secondary btn-sm icon-btn" onClick={handleDownloadLogsClick}>
        ...
        <td className="text-end">
          <div className="btn-group " role="group">
            <button type="button" className="btn btn-secondary btn-sm icon-btn" onClick={handleShow} >
              <FontAwesomeIcon icon={faWrench} />
            </button>
          </div>
        </td>
        <td className="text-end" key={branch.name} onClick={() => setSelectedBranch(branch)}>
          <div className="btn-group" role="group">
            <button type="button" className="btn btn-secondary btn-sm icon-btn" onClick={() => handleBuildClick(branch.name)} >
...
<div> 
  ...
  <Modal.Header closeButton>
    ...
    <Modal.Title style={{ color:'white' ,  fontFamily: 'Arial' }}>Build Configuration</Modal.Title>
  </Modal.Header>
  ...
  <hr style={{ margin: "20px 0px", padding: "0px" }} />  <div className="d-flex justify-content-between align-items-center mb-4">
    <div>
      <h6 style={{color:'white'  }}>Android Module : </h6>
  ...
  <Form.Group>
    <FormControl
      as="select"
      value={selectedAndroidmodule}
      onChange={handleAndroidModuleChange}
      style={{ width: '100%', maxWidth: '500px', fontSize: "16px" }}
    >          
       <option value="Release">Select the Android Module </option>
